...
const BlogDetailsPage = () => {
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      await api.post(`/blogs/${blog._id}/comments`, { content: comment });
      setComment('');
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4 space-x-reverse">
              ...
              <h1 className="text-xl font-semibold text-gray-900">مقاله</h1>
            </div>
          ...
          {blog.author && (
            <div className="flex items-center space-x-3 space-x-reverse p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                {blog.author.writerProfile?.specialization && (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <span>{blog.likes?.length || 0} لایک</span>
              </button>
            </div>
          </div>
